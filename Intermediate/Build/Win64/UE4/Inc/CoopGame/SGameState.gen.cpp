...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_CoopGame_EWaveState_CRC() { return 394901488U; }
	...
	UFunction* Z_Construct_UFunction_ASGameState_OnRep_WaveState()
	{
		...
		if (!ReturnFunction)
		{
			static const UE4CodeGen_Private::FEnumPropertyParams NewProp_OldState = { UE4CodeGen_Private::EPropertyClass::Enum, "OldState", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, STRUCT_OFFSET(SGameState_eventOnRep_WaveState_Parms, OldState), Z_Construct_UEnum_CoopGame_EWaveState, METADATA_PARAMS(nullptr, 0) };
	...
	UClass* Z_Construct_UClass_ASGameState()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				{ &Z_Construct_UFunction_ASGameState_OnRep_WaveState, "OnRep_WaveState" }, // 3905522888
				{ &Z_Construct_UFunction_ASGameState_WaveStateChanged, "WaveStateChanged" }, // 3598040982
			};
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FEnumPropertyParams NewProp_WaveState = { UE4CodeGen_Private::EPropertyClass::Enum, "WaveState", RF_Public|RF_Transient|RF_MarkAsNative, 0x0020080100000034, 1, "OnRep_WaveState", STRUCT_OFFSET(ASGameState, WaveState), Z_Construct_UEnum_CoopGame_EWaveState, METADATA_PARAMS(NewProp_WaveState_MetaData, ARRAY_COUNT(NewProp_WaveState_MetaData)) };
	...
	IMPLEMENT_CLASS(ASGameState, 1725056105);
