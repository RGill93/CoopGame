...
// End Cross Module References
	...
	UFunction* Z_Construct_UFunction_ASCharacter_StartFire()
	{
		...
		if (!ReturnFunction)
		{
			...
			static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
				{ "Category", "Player" },
				{ "ModuleRelativePath", "Public/SCharacter.h" },
				{ "ToolTip", "Function for player fire" },
			};
#endif
	...
	UClass* Z_Construct_UClass_ASCharacter()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				{ &Z_Construct_UFunction_ASCharacter_OnHealthChanged, "OnHealthChanged" }, // 4130007828
				{ &Z_Construct_UFunction_ASCharacter_StartFire, "StartFire" }, // 2977988831
				{ &Z_Construct_UFunction_ASCharacter_StopFire, "StopFire" }, // 3465346643
			};
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ZoomedFOV_MetaData[] = {
				{ "Category", "Player" },
				{ "ModuleRelativePath", "Public/SCharacter.h" },
				{ "ToolTip", "Allows the player to set there values in the editor" },
			};
#endif
			...
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_SpringArmComp_MetaData[] = {
				...
				{ "EditInline", "true" },
				{ "ModuleRelativePath", "Public/SCharacter.h" },
				{ "ToolTip", "Creating a Camera component" },
			};
#endif
	...
	IMPLEMENT_CLASS(ASCharacter, 1309018906);
